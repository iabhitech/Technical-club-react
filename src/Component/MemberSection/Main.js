  ...
  return (
    <main>
      <div className="container-fluid dashboard">
        ...
        earum adipisci corporis rem laborum voluptas, itaque in cupiditate optio
        quae ex dicta hic consequatur debitis. Maxime tempora necessitatibus
        explicabo!
        <div className="card-deck mb-2 feature-card">
          <div className="card m-2">
            <div className="text-center mt-4">
              <i
                className="fa fa-laptop-code fa-3x blue-text"
                aria-hidden="true"
              ></i>
              <div className="pt-2">
          ...
          <div className="card m-2">
            <div className="text-center mt-4">
              <i
                className="fa fa-chart-area fa-3x teal-text"
                aria-hidden="true"
              ></i>
              <div className="pt-2">
          ...
          <div className="card m-2">
            <div className="text-center mt-4">
              <i
                className="fab fa-sketch fa-3x indigo-text"
                aria-hidden="true"
              ></i>
              <div className="pt-2">
          ...
          <div className="card m-2">
            <div className="text-center mt-4">
              <i
                className="fas fa-tasks fa-3x blue-text"
                aria-hidden="true"
              ></i>
              <div className="pt-2">
            ...
            <div className="card">
              ...
              <div className="text-center d-flex flex-column m-auto card-body">
                <img
                  src="https://mdbootstrap.com/img/Photos/Avatars/avatar-2.jpg"
                  alt=""
                  className="avatar rounded-circle avatar-xxl"
                />
              ...
              <hr className="mb-0" />
              <div className="card-body">
                <div className="d-flex blue-text">
                  <i className="fas fa-star-half-alt my-auto mr-1"></i> Rating{" "}
                  <span className="ml-auto">4.2</span>
                </div>
                <div className="d-flex blue-text">
                  <i className="fas fa-tasks my-auto mr-1"></i> Event Organise{" "}
