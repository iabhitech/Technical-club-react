      ...
      <div className="card text-left mb-2 ">
        <div className="card-body">
          <div className="d-flex">
            ...
            />
            <form action="" className="w-100 mb-0">
              ...
              <div className="d-flex align-items-center">
                ...
                <button type="button" className="btn btn-primary btn-sm ml-auto btn-rounded">
                  Share
                </button>
              </div>
            </form>
        ...
        <ul className="list-unstyled">
          <li className="list-item mb-2 card p-3">
            ...
            <div className="font-weight-normal">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Autem saepe asperiores deserunt quae itaque et
              aperiam magni aliquam corrupti sed veritatis totam, pariatur cum quam nostrum eligendi labore repellat!
              Quasi?
            </div>
