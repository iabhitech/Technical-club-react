...
const ClubDisscussion = () => {
  return (
    <div id="chatBox" className="chatbox">
      <div className="card chat-room small-chat wide mt-2" name="reciverId" id="myForm1">
        <div className="card-header white d-inline-flex justify-content-between p-2" id="toggleChat">
          <div className="heading d-flex justify-content-start">
            ...
            <div className="data ml-3">
              ...
              <span className="activity text-muted small mb-0" id="lastSeenChatter">
                Last Message
              </span>
              <span className="text-muted mb-0 small"> 2 min ago</span>
            </div>
          </div>
        ...
        <div className="chat-scroll" id="message" style={{ "max-height": "340px" }}>
          <div className="card-body p-3">
            <div className="chat-message">
              ...
              <div className="last ml-auto chat-card">
                <div className="card bg-primary rounded z-depth-0 mb-1 message-text text-left">
                  <div className="card-body p-2">
                    ...
                    <div className="small align-bottom time-massage1chatmassage">
                      <i class="far fa-clock" aria-hidden="true"></i> 2 min ago
                    </div>
                  </div>
                </div>
              </div>

              <div className="last chat-card">
                <div className="d-flex">
                  ...
                  <div className="card bg-light rounded z-depth-0 mb-1 message-text">
                    <div className="card-body p-2">
                      ...
                      <span className="small align-bottom time-massage1chatmassage">chat[1]</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="card-footer text-muted white pt-1 pb-2 px-3 mt-auto d-flex align-items-center">
          <div>
            <a type="button" data-toggle="dropdown" aria-expanded="false" href="#/">
              <i className="far fa-laugh mr-2"></i>
            </a>
            <div className="reactions dropdown-menu p-2">
          ...
          <textarea
            className="form-control mr-3 message-box"
            name=""
