    ...
    <nav className="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar">
      <div className="container-fluid mx-md-5">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent1">
          ...
          <ul className="navbar-nav nav-flex-icons ml-auto align-items-center ">
            <li className="nav-item">
            ...
            (localStorage.getItem("token") && localStorage.getItem("role").toString() === "Genral User") ? (
              <li className="nav-item avatar dropdown ml-1" style={{ color: "white" }}>
                <a
                ...
                <div className="dropdown-menu dropdown-menu-lg-right p-2" aria-labelledby="navbarDropdownMenuLink-55">
          ...
          {user.userRole?.toString() === "" && !localStorage.getItem("token") ? (
            <div className="" role="tablist">
              <a className="btn btn-sm btn-primary" href="#account" onClick={register}>
                Register
              </a>
              <a className="btn btn-sm btn-outline-primary" href="#account" onClick={login}>
                Login
              </a>
            </div>
          ) : (
          ...
          (localStorage.getItem("token") && localStorage.getItem("role")?.toString() === "Member") ? (
            <div className="" role="tablist" id="forMember">
              <a className="btn btn-sm btn-primary" href="#account" onClick={register}>
                Club Discussion
              </a>
              <a className="btn btn-sm btn-primary" href="#account" onClick={login}>
