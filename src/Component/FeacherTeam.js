      ...
      <section className="px-md-5 mx-md-5 text-center dark-grey-text">
        <div className="row d-flex justify-content-center">
          <div className="col-xl-6 col-md-8">
            ...
            <p className="text-muted">
              ...
              implementing capacity that can shape their intellect and future.
              To do that we have four core teams to function effectively and to
        ...
        <div className="row">
          <div className="col-lg-3 col-md-6">
            ...
            <p className="text-muted">
              Consists of skilled and experienced members in terms of various
              technical aspects and technological attributes.
            </p>
          </div>
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <p className="text-muted">
              Comprises of students skilled at using various illustration tools
              and are endowed with a creative outlook.
            </p>
          </div>
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <p className="text-muted">
              A bunch of students having excellence at managing and coordinating
              person & people and events at different levels.
            </p>
          </div>
        </div>
      </section>
